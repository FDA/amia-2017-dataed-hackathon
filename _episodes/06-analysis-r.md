...
We can begin by loading the additional packages `dendextend`, `dendextendRcpp`, and `NMF` that will be used in this lesson (they should installed following the instructions on the [Setup]({{ page.root }}/setup/) page first).
